import fs from 'fs';
import type { ResponseLike } from 'finbud-data/internal/to-file';
import { toFile } from 'finbud-data/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('finbud-data/core/uploads');
    await expect(
